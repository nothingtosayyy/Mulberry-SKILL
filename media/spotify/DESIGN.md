...
Spotify 的设计语言强调品牌识别与一致性。整体以深色画布为底,辅以 **Spotify** 的标志色 `#1db954` 作为点睛。

## 视觉主题

整体基调由 Spotify 的品牌色 `#1db954` 主导,搭配深色表面与高对比度排版。
...
| Brand Primary | `#1db954` | 品牌点缀 |
| Brand Accent | `#1db954` | 交互高亮 |
