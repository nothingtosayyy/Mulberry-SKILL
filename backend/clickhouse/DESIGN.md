...
ClickHouse 的设计语言强调品牌识别与一致性。整体以深色画布为底,辅以 **ClickHouse** 的标志色 `#faff69` 作为点睛。

## 视觉主题

整体基调由 ClickHouse 的品牌色 `#faff69` 主导,搭配深色表面与高对比度排版。
...
| Brand Primary | `#faff69` | 品牌点缀 |
| Brand Accent | `#faff69` | 交互高亮 |
