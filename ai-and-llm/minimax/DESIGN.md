...
Minimax 的设计语言强调品牌识别与一致性。整体以深色画布为底,辅以 **Minimax** 的标志色 `#00d4aa` 作为点睛。

## 视觉主题

整体基调由 Minimax 的品牌色 `#00d4aa` 主导,搭配深色表面与高对比度排版。
...
| Brand Primary | `#00d4aa` | 品牌点缀 |
| Brand Accent | `#00d4aa` | 交互高亮 |
